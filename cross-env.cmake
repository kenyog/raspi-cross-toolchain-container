...
set(tools /opt/toolchain/cross-pi-gcc-10.2.0-2) # warning change toolchain path here.
set(rootfs_dir /opt/sysroot) # warning make sure rootfs exist at this path
...
set(CMAKE_C_FLAGS "${CMAKE_CXX_FLAGS} -I${CMAKE_SYSROOT}/usr/include/arm-linux-gnueabihf -fPIC -Wl,-rpath-link,${CMAKE_SYSROOT}/usr/lib/${CMAKE_LIBRARY_ARCHITECTURE} -L${CMAKE_SYSROOT}/usr/lib/${CMAKE_LIBRARY_ARCHITECTURE}")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -I${CMAKE_SYSROOT}/usr/include/arm-linux-gnueabihf -fPIC -Wl,-rpath-link,${CMAKE_SYSROOT}/usr/lib/${CMAKE_LIBRARY_ARCHITECTURE} -L${CMAKE_SYSROOT}/usr/lib/${CMAKE_LIBRARY_ARCHITECTURE}")
